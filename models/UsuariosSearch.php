...
class UsuariosSearch extends Usuarios
{
    ...
    public function rules()
    {
        return [
            ...
            [['nombre_usuario', 'contrasena', 'nombre', 'email', 'estado_civil', 'direccion', 'numero_oficina', 'ciudad', 'provincia', 'codigo_postal', 'numero_casa', 'numero_trabajo', 'numero_movil', 'cargo_trabajo', 'fecha_registro', 'fecha_conexion', 'fecha_modif'], 'safe'],
        ];
    }
