<?php
	...
	$conf['servers'][0]['desc'] = 'CentOS-6.3-Juanchi';
	...
	$conf['servers'][0]['pg_dump_path'] = '/usr/pgsql-9.5/bin/pg_dump';
	$conf['servers'][0]['pg_dumpall_path'] = '/usr/pgsql-9.5/bin/pg_dumpall';
