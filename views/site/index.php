	...
	<div id="camera" class="camera-wrap">
		<div data-src="../../images/index_slide01.jpg">
			<div class="fadeIn camera_caption">
				<h2 class="text_1 color_1">El auto que usted necesita!</h2>
				<a class="btn_1" href="#">Más Detalles</a>
			</div>
		</div>
		<div data-src="../../images/index_slide02.jpg">
			<div class="fadeIn camera_caption">
				<h2 class="text_1 color_1">Autos al mejor precio!</h2>
				<a class="btn_1" href="#">Más Detalles</a>
			</div>
		</div>
		<div data-src="../../images/index_slide03.jpg">
			<div class="fadeIn camera_caption">
				<h2 class="text_1 color_1">Ofrecemos la mejor financiación!</h2>
				<a class="btn_1" href="#">Más Detalles</a>
			</div>
		</div>
	</div>
